...
export function MenuItem({
  ...
  return (
    <button
      ...
      role="menuitem"
      onClick={onClick}
      className={`flex w-full items-center gap-2.5 rounded-lg px-2.5 py-1.5 text-left text-[13px] transition-colors pointer-coarse:py-2.5 pointer-coarse:text-[15px] hover:bg-[var(--hover)] ${
