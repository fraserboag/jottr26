...
export function ToolButton({
  ...
  return (
    <button
      ...
      className={`grid size-8 shrink-0 touch-manipulation place-items-center rounded-md transition-colors disabled:pointer-events-none disabled:opacity-35 pointer-coarse:size-10 pointer-coarse:[&_svg]:size-5 ${
