...
export function ToolButton({
  ...
  return (
    <button
      ...
      className={`grid size-8 shrink-0 touch-manipulation place-items-center rounded-md transition-colors disabled:pointer-events-none disabled:opacity-35 pointer-coarse:size-11 pointer-coarse:[&_svg]:size-5 ${
    ...
    >
      <Icon name={icon} size={17} strokeWidth={active ? 2.1 : 1.8} />
    </button>
  )
}
