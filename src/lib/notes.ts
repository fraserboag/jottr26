...
// offline, which breaks the offline-first requirement in CONTEXT.md. The
// write itself still happens; callers just don't wait on it, same as
// updateNote/deleteNote below.
